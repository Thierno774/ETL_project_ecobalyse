...
from extractJSON import main
from simulations import generate_simulations
...
def save_json_file(task_instance):
    # Generate 2000 simulations avec une limite de 60 requêtes par minute
    simulations = task_instance.xcom_pull(task_ids = "simulations_data")
    ...
    filename = os.path.join(directory_to_save_data, "simulations.json")
...
with DAG( "ecobalyse_dag", 
        ...
        simulations_json_task = PythonOperator(
                                            task_id = "simulations_data",
                                            python_callable = generate_simulations, 
                                            op_kwargs={'max_requests_per_minute': 60}
        )
        save_json_file_task = PythonOperator(
                                        task_id = "save_json_file",
        ...
        extract_data_task >> simulations_json_task >> save_json_file_task
        save_json_file_task >> load_json_file_task
