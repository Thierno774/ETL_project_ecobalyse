...
def main():
    ...
    filename_schemas = "schemas.json"

    parameters_json_file = os.path.join(directory_to_save_data, filename_parameters)
    schemas_json_file = os.path.join(directory_to_save_data, filename_schemas)


    with open(parameters_json_file, "w") as json_file:
        json.dump(combined_data, json_file, indent=4)


    with open(schemas_json_file, "w") as json_file:
